...
func TestApiProduct(t *testing.T) {
	...
	expected = `{"status":200,"data":{"id":1,"title":"Milk Shake","description":"Milk Shake","link":"https://test.com/test","image":"","barcode":"1234567890Z","category_ids":[1],"categories":[{"id":1,"title":"Drinks"}],"list_id":1,"list":{"id":1,"title":"Fridge"},"stock":0},"error":""}`
	assert.Equal(t, expected, actual)
	fmt.Println(" OK")
	...
	expected = `{"status":200,"data":{"id":1,"title":"Milk Shake 2","description":"Milk Shake 2","link":"https://test.com/test","image":"","barcode":"1234567890Z","category_ids":[1],"categories":[{"id":1,"title":"Drinks"}],"list_id":1,"list":{"id":1,"title":"Fridge"},"stock":0},"error":""}`
	assert.Equal(t, expected, actual)
	fmt.Println(" OK")
	...
	actual = getRequest(generateApiUrl("/api/v1/product/"))
	expected = `{"status":200,"data":[{"id":1,"title":"Milk Shake 2","description":"Milk Shake 2","link":"https://test.com/test","image":"","barcode":"1234567890Z","category_ids":[1],"categories":[],"list_id":1,"list":null,"stock":0}],"error":""}`
	assert.Equal(t, expected, actual)
	fmt.Println(" OK")
